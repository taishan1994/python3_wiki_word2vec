...
if __name__ == '__main__':
    fdir = '/data02/gob/model_hub/wiki_zh_pinyin_vec/'
    # model = KeyedVectors.load_word2vec_format(fdir+'wiki.zh.text.vector', binary=False, unicode_errors='ignore')
    model = KeyedVectors.load_word2vec_format(fdir+'wiki.zh.text.pinyin.vector', binary=False)
    word = model.most_similar("chou3")
    print('==============================')
    print('求chou3的相似词：')
    for t in word:
        print(t[0],t[1])
    print('==============================')
    print('==============================')
    word = model.most_similar("gong1")
    print('求gong1的相似词：')
    for t in word:
        print(t[0],t[1])
    print('==============================')
    print('==============================')
    word = model.most_similar("mei3")
    print('求mei3的相似词：')
    for t in word:
        print(t[0],t[1])
    print('==============================')
